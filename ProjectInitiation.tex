...
\begin{itemize}
	\item[\HUGE $\cdot$] \textbf{Code required:} Integrating the system Hadoop into the pm4py interface and read files from it
...
\begin{itemize}
\item Python 3.7 as back end programming language
